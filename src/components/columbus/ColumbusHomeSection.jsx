  ...
  return (
    ...
    <div className='w-full h-[300px] md:h-[400px] lg:h-[320px] bg-[#00112c] mb-4 lg:py-14 py-7'>
        ...
        <div className='w-[88%] lg:w-[85%] my-0 mx-auto py-4 flex flex-col gap-4'>
            ...
            <p className='domain-name text-white text-[30px] md:text-[40px] lg:text-[40px] xl:text-[48px] font-semibold my-[-10px] lg:my-[-1rem]'>ColumbusRealEstate.com</p>
    ...
    <div className='w-full border-t lg:border-none py-8'>
        ...
        className='w-fit my-3 py-2 font-semibold hover:bg-gray-200 hover:rounded-md pr-4 cursor-pointer flex gap-1 items-center'>Here's how it works <IoArrowForward size={20}/> </p>
        </div>
    </div>
    ...
    {openModal && (
        <div onClick={() => setOpenModal(false)} 
          ...
          <div onClick={(e) => e.stopPropagation()}
           className="bg-white w-[90%] md:w-[600px] lg:w-[700px] max-h-[95vh] rounded-xl shadow-2xl absolutee p-8 relative">
...
export default ColumbusHomeSection
